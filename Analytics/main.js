    ...
    var DomStrings = {
     ...
     return {
         ...
         clearFields: function() {
            var htmlFields, fieldsArr;
            htmlFields = document.querySelectorAll(DomStrings.inputDescription + ', ' + DomStrings.inputValue);
            fieldsArr = Array.prototype.slice.call(htmlFields);
